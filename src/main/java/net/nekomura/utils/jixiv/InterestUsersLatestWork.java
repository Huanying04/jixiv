...
/**
 * 關注使用者的最新作品<br>
 * 被{@link FollowingLatestWork}和{@link MyPixivLatestWork} extend
 */
public class InterestUsersLatestWork {
    private final JSONObject data;
    private final String type;

    public InterestUsersLatestWork(JSONObject data, String type) {
        this.data = data;
        this.type = type;
    }
